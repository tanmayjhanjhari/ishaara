...
export const ISL_ALPHABET = {
  A: {
    ...
    type: 'static',
    difficulty: 1,
    cameraHint: "Face your palm toward the camera slightly",
  ...
  B: {
    ...
    type: 'static',
    difficulty: 1,
    cameraHint: "Hold hand flat — fingers clearly visible",
  ...
  C: {
    ...
    type: 'static',
    difficulty: 1,
    cameraHint: "Show the curve clearly to the camera",
  ...
  D: {
    ...
    type: 'static',
    difficulty: 2,
    cameraHint: 'Show palm facing camera — left index STRAIGHT UP, right hand curves around it',
  ...
  G: {
    ...
    type: 'static',
    difficulty: 2,
    cameraHint: 'Stack fists vertically — both fists clearly visible to camera',
  ...
  H: {
    ...
    type: 'static',
    difficulty: 2,
    cameraHint: 'Keep both hands flat and parallel — sweeping motion toward camera',
  ...
  I: {
    ...
    type: 'static',
    difficulty: 2,
    cameraHint: "Both index fingers must be visible",
  ...
  J: {
    ...
    type: 'motion',
    difficulty: 3,
    cameraHint: "Keep hand centered while tracing the J",
  ...
  K: {
    ...
    type: 'static',
    difficulty: 2,
    cameraHint: 'Face palm toward camera — hooked finger clearly touching middle joint',
  ...
  P: {
    ...
    type: 'static',
    difficulty: 3,
    cameraHint: 'Loop touches top of upright finger — both hands visible and centered',
  ...
  Q: {
    ...
    type: 'static',
    difficulty: 3,
    cameraHint: 'Non-dominant makes a circle — dominant index hooks over its top',
  ...
  V: {
    ...
    type: 'static',
    difficulty: 1,
    cameraHint: "Spread fingers wide — clear V shape",
